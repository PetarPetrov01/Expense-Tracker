...
import { symbolToCode } from '../../src/lib/currency';
    ...
    <View style={{ flex: 1, backgroundColor: theme.colors.bg, padding: theme.spacing.lg, gap: theme.spacing.lg }}>
      <View>
        ...
        <View style={{ flexDirection: 'row', gap: theme.spacing.sm }}>
          {SYMBOLS.map(s => (
            <Pressable key={s} onPress={() => setDisplayCurrency(symbolToCode(s))} style={{
              flex: 1, padding: theme.spacing.md, borderRadius: theme.radius.md, alignItems: 'center',
              backgroundColor: displayCurrency === symbolToCode(s) ? theme.colors.primary : theme.colors.surface,
            }}>
